...
namespace EventBooking.API.Migrations
{
    ...
    [Migration("20251010050823_AddRefundCancellationSupport")]
    partial class AddRefundCancellationSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventBooking.API.Models.EventBookingRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventBooking.API.Models.OrganizerTicketPayment", b =>
                {
                    ...
                    b.HasIndex("BookingLineItemId", "Status")
            ...
            modelBuilder.Entity("EventBooking.API.Models.SeatReservation", b =>
                {
                    ...
                    b.HasIndex("ExpiresAt", "IsConfirmed");
            ...
            modelBuilder.Entity("EventBooking.API.Models.Booking", b =>
                {
                    ...
                    b.HasOne("EventBooking.API.Models.ApplicationUser", "RefundedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("EventBooking.API.Models.SeatReservation", b =>
                {
                    ...
                    b.HasOne("EventBooking.API.Models.Seat", "Seat")
                        .WithMany()
